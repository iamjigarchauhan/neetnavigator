...
<div class="content-wrapper">
    <form class="forms-sample" action="{{ isset($blog) ? route('admin.blog.category.update',$blog->id) : route('admin.blog.category.save') }}" method="POST" enctype="multipart/form-data">
    @csrf()
    <div class="row"> 
        <div class="col-md-5 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ isset($blog) ? 'Edit Blog Category' : 'Add Blog Category' }}</h4>
                    @if($errors->any())
