            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ isset($blog) ? 'View Blog' : 'Add Blog' }}</h4>
                        ...
                        <div class="form-group">
                            <label for="title">Featured</label> <br/>
                            <label><b> {{ $blog->is_featured ? 'Yes':'No' }}</b> <label>
                        </div>
                        <div class="form-group">
                            <label for="title">Featured Image</label> <br/>
                            <label><b> {!! $blog->hasMedia('Featured') ? '<img width="300px" src="'.$blog->firstMedia('Featured')->getUrl().'">' : ''; !!}</b> <label>
                        </div>
                        <div class="form-group">
