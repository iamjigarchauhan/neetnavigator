...
<div class="row mb-6">
    ...
    <div class="form-floating">
        ...
        <input name="pincode" type="number" maxlength="6" class="form-control" id="floatingPincode" placeholder="" value="{{ old('pincode') }}" required />
...
<div class="row mb-6">
    <div class="col-lg-6 fv-row">
        <div class="form-floating">
            ...
            <input name="state" type="text" class="form-control mb-3 mb-lg-0" id="floatingState" placeholder="" value="{{ old('state') }}" required />
            @if ($errors->has('state'))
